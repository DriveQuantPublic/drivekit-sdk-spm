...
typedef SWIFT_ENUM(NSInteger, DKVehicleBrand, open) {
  ...
  DKVehicleBrandAiways = 1,
  DKVehicleBrandAlpha_romeo = 2,
  DKVehicleBrandAlpina = 3,
  DKVehicleBrandAlpine = 4,
  DKVehicleBrandAston_martin = 5,
  DKVehicleBrandAudi = 6,
  DKVehicleBrandBentley = 7,
  DKVehicleBrandBmw = 8,
  DKVehicleBrandBollore = 9,
  DKVehicleBrandBugatti = 10,
  DKVehicleBrandByd = 11,
  DKVehicleBrandCadillac = 12,
  DKVehicleBrandCaterham = 13,
  DKVehicleBrandChevrolet = 14,
  DKVehicleBrandChrysler = 15,
  DKVehicleBrandCitroen = 16,
  DKVehicleBrandCupra = 17,
  DKVehicleBrandDacia = 18,
  DKVehicleBrandDaewoo = 19,
  DKVehicleBrandDaf_truck = 20,
  DKVehicleBrandDaihatsu = 21,
  DKVehicleBrandDe_tomaso = 22,
  DKVehicleBrandDodge = 23,
  DKVehicleBrandDonkervoort = 24,
  DKVehicleBrandDs = 25,
  DKVehicleBrandFam_automobiles = 26,
  DKVehicleBrandFerrari = 27,
  DKVehicleBrandFiat = 28,
  DKVehicleBrandFisker = 29,
  DKVehicleBrandFord = 30,
  DKVehicleBrandGinetta = 31,
  DKVehicleBrandHommell = 32,
  DKVehicleBrandHonda = 33,
  DKVehicleBrandHummer = 34,
  DKVehicleBrandHyundai = 35,
  DKVehicleBrandInfiniti = 36,
  DKVehicleBrandIsuzu = 37,
  DKVehicleBrandIveco = 38,
  DKVehicleBrandIveco_truck = 39,
  DKVehicleBrandJaguar = 40,
  DKVehicleBrandJeep = 41,
  DKVehicleBrandKia = 42,
  DKVehicleBrandKtm = 43,
  DKVehicleBrandLada = 44,
  DKVehicleBrandLamborghini = 45,
  DKVehicleBrandLancia = 46,
  DKVehicleBrandLand_rover = 47,
  DKVehicleBrandLdv = 48,
  DKVehicleBrandLeapmotor = 49,
  DKVehicleBrandLexus = 50,
  DKVehicleBrandLotus = 51,
  DKVehicleBrandMahindra = 52,
  DKVehicleBrandMan = 53,
  DKVehicleBrandMan_truck = 54,
  DKVehicleBrandMaserati = 55,
  DKVehicleBrandMatra = 56,
  DKVehicleBrandMaybach = 57,
  DKVehicleBrandMazda = 58,
  DKVehicleBrandMclaren = 59,
  DKVehicleBrandMega = 60,
  DKVehicleBrandMercedes = 61,
  DKVehicleBrandMercedes_amg = 62,
  DKVehicleBrandMercedes_truck = 63,
  DKVehicleBrandMg = 64,
  DKVehicleBrandMia_electric = 65,
  DKVehicleBrandMini = 66,
  DKVehicleBrandMitsubishi = 67,
  DKVehicleBrandMorgan = 68,
  DKVehicleBrandNissan = 69,
  DKVehicleBrandOpel = 70,
  DKVehicleBrandPeugeot = 71,
  DKVehicleBrandPgo = 72,
  DKVehicleBrandPolestar = 73,
  DKVehicleBrandPorsche = 74,
  DKVehicleBrandRenault = 75,
  DKVehicleBrandRenault_truck = 76,
  DKVehicleBrandRolls_royce = 77,
  DKVehicleBrandRover = 78,
  DKVehicleBrandSaab = 79,
  DKVehicleBrandSantana = 80,
  DKVehicleBrandScania_truck = 81,
  DKVehicleBrandSeat = 82,
  DKVehicleBrandSecma = 83,
  DKVehicleBrandSeres = 84,
  DKVehicleBrandSkoda = 85,
  DKVehicleBrandSmart = 86,
  DKVehicleBrandSsangyong = 87,
  DKVehicleBrandSubaru = 88,
  DKVehicleBrandSuzuki = 89,
  DKVehicleBrandTesla = 90,
  DKVehicleBrandToyota = 91,
  DKVehicleBrandTriumph = 92,
  DKVehicleBrandTvr = 93,
  DKVehicleBrandVenturi = 94,
  DKVehicleBrandVinfast = 95,
  DKVehicleBrandVolkswagen = 96,
  DKVehicleBrandVolvo = 97,
  DKVehicleBrandVolvo_truck = 98,
  DKVehicleBrandWestfield = 99,
  DKVehicleBrandWiesmann = 100,
  DKVehicleBrandXpeng = 101,
};
...
@class DKVehicle;
SWIFT_ENUM_FWD_DECL(NSInteger, DKDetectionMode)
...
- (id <DKTripLocation> _Nullable)getVehicleLocation:(NSString * _Nonnull)vehicleId SWIFT_WARN_UNUSED_RESULT;
