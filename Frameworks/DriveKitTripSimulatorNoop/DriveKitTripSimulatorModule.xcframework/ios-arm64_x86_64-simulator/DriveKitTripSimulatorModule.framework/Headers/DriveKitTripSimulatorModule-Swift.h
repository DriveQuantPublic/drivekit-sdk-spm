...
#ifndef DRIVEKITTRIPSIMULATORMODULE_SWIFT_H
#define DRIVEKITTRIPSIMULATORMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DriveKitTripSimulatorModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_ENUM_FWD_DECL(NSInteger, PresetCrashConfiguration)
SWIFT_ENUM_FWD_DECL(NSInteger, PresetTrip)
SWIFT_ENUM_FWD_DECL(NSInteger, PresetCrash)
@protocol DKTripSimulatorDelegate;
SWIFT_CLASS("_TtC27DriveKitTripSimulatorModule21DriveKitTripSimulator")
@interface DriveKitTripSimulator : NSObject
...
- (void)initialize;
- (void)startCrashTrip:(enum PresetCrashConfiguration)config;
