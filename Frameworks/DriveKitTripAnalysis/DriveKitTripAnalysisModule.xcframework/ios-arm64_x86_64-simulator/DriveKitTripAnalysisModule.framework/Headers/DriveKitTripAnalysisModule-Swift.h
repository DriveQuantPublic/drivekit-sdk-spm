...
@class NSDate;
SWIFT_ENUM_FWD_DECL(NSInteger, StartMode)
...
SWIFT_ENUM_FWD_DECL(NSInteger, DKWorkingHoursTimeSlotStatus)
...
SWIFT_ENUM_FWD_DECL(NSInteger, DKDay)
...
SWIFT_ENUM_FWD_DECL(NSInteger, TripResponseStatusType)
@class DKTrip;
